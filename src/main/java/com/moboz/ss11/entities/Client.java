package com.moboz.ss11.entities;
...
public class Client {
    ...
    public void setRedirectUri(String redirectedUri) {
        this.redirectUri = redirectedUri;
    }
    ...
    public static Client from(RegisteredClient registeredClient) {
        ...
        client.setRedirectUri(                    //  NOT CLEAN CODE, SIMPLIFYING EXAMPLE
